    ...
    <div class="col-lg-8">
      <form method="post" action="/dashboard/posts/{{ $post->slug }}">
        ...
        <div class="input-group date mb-4">
          ...
          <input type="text" class="form-control" id="datestart" name="datestart" placeholder="Start Date" value="{{ old('datestart', $post->datestart) }}">
          <span class="input-group-append">
          </span>
          {{--  <span class="input-group-text" id="inputGroup-sizing-default"></span>  --}}
          <input type="text" class="form-control" id="dateend" name="dateend" placeholder="Date Line" value="{{ old('dateend', $post->dateend) }}">
          <span class="input-group-append">
          </span>
        </div>
        <div class="mb-3">
          <label for="categories_id" class="form-label">Division</label>
          <select class="form-select" name="categories_id" value="{{ old('categories_id'.$post->categories_id) }}">
